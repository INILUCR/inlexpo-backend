...
('Trozo grande de un material compacto.',1,6,1,1),
('Pieza compacta en forma de paralelepípedo rectángulo.',2,6,1,1),
('Agrupación generalmente ocasional de partidos políticos, países o asociaciones.',3,6,1,1),
('Pieza de pan abierta, o conjunto de dos rebanadas, en cuyo interior se coloca o se unta algún alimento.',1,7,1,1),
('Refrigerio que los trabajadores y estudiantes suelen tomar entre el desayuno y la comida.',2,7,1,1),
('bocado (‖ porción pequeña de comida).',3,7,1,1),
('Lugar donde se guarda y cría el vino.',1,8,1,1),
('Almacén de vinos.',2,8,1,1),
('Tienda de vinos.',3,8,1,1),
('Sistema de escritura para ciegos que consiste en signos dibujados en relieve para poder leer con los dedos.',1,9,1,1),
('Instrumento consistente en una caja en cuyo interior una aguja imantada gira sobre un eje y señala el norte magnético, que sirve para determinar las direcciones de la superficie terrestre.',1,10,1,1),
('Abertura por donde, entrecerrando los ojos, se mira mejor un objeto.',2,10,1,1),
('En una embarcación, instrumento que indica el rumbo, consistente en una caja, redonda y de bronce, con dos círculos concéntricos, de los cuales solo gira el interior, que lleva la aguja magnética, mientras que el exterior, fijo, lleva señalada la dirección de la quilla del buque.',3,10,1,1),
('Conversar, platicar.',1,11,5,1),
('Hablar mucho, sin sustancia o fuera de propósito.',2,11,5,1),
('parlar (‖ revelar lo que se debe callar).',1,11,5,1),
('Mandato escrito de pago, para cobrar una cantidad determinada de los fondos que quien lo expide tiene disponibles en un banco.',1,12,1,1),
('Usada para expresar asentimiento o conformidad.',2,12,7,1),
('Persona que compra en una tienda, o que utiliza con asiduidad los servicios de un profesional o empresa.',1,13,1,1),
('Persona que está bajo la protección o tutela de otra.',2,13,1,1),
('Conjunto de condiciones atmosféricas que caracterizan una región.',1,14,1,1),
('ambiente (‖ condiciones o circunstancias).',2,14,1,1),
('País, región.',1,14,1,1),
('Hacer comestible un alimento crudo sometiéndolo a ebullición o a la acción del vapor.',1,15,5,1),
('Someter pan, cerámica, piedra caliza, etc., a la acción del calor en un horno, para que pierdan humedad y adquieran determinadas propiedades.',2,15,5,1),
('Someter algo a la acción del fuego en un líquido para que comunique a este ciertas cualidades.',3,15,5,1);
